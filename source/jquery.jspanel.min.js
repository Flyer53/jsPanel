var jsPanel;
(function(d){jsPanel={version:"2.2.0 2014-12-02 09:57",ID:0,widthForMinimized:150,hintsTc:[],hintsTl:[],hintsTr:[],template:'<div class="jsPanel jsPanel-theme-default"><div class="jsPanel-hdr jsPanel-theme-default"><h3 class="jsPanel-title"></h3><div class="jsPanel-hdr-r"><div class="jsPanel-btn-close"><span class="jsglyph jsglyph-remove"></span></div><div class="jsPanel-btn-max"><span class="jsglyph jsglyph-maximize"></span></div><div class="jsPanel-btn-norm"><span class="jsglyph jsglyph-normalize"></span></div><div class="jsPanel-btn-min"><span class="jsglyph jsglyph-minimize"></span></div><div class="jsPanel-btn-small"><span class="jsglyph jsglyph-chevron-up"></span></div><div class="jsPanel-btn-smallrev"><span class="jsglyph jsglyph-chevron-down"></span></div></div><div class="jsPanel-hdr-toolbar jsPanel-clearfix"></div></div><div class="jsPanel-content jsPanel-theme-default"></div><div class="jsPanel-ftr jsPanel-theme-default jsPanel-clearfix"></div></div>',addToolbar:function(a,
b,c){"header"===b?jsPanel.configToolbar(c,a.header.toolbar,a):"footer"===b&&(a.footer.css({display:"block",padding:"5px 20px 5px 5px"}),jsPanel.configToolbar(c,a.footer,a));return a},autoclose:function(a,b){var c=d("#"+b);0<c.length&&c.fadeOut("slow",function(){a.close()})},calcPos:function(a,b,c,f){"auto"===b.position[a]?b.position[a]=30*c+"px":d.isFunction(b.position[a])?b.position[a]=b.position[a](f):b.position[a]=0===b.position[a]?"0":parseInt(b.position[a],10)+"px";"body"===b.selector&&("top"===
a&&(b.position.top=parseInt(b.position.top,10)+jsPanel.winscrollTop()+"px"),"bottom"===a&&(b.position.bottom=parseInt(b.position.bottom,10)-jsPanel.winscrollTop()+"px"),"left"===a&&(b.position.left=parseInt(b.position.left,10)+jsPanel.winscrollLeft()+"px"),"right"===a&&(b.position.right=parseInt(b.position.right,10)-jsPanel.winscrollLeft()+"px"));return b.position[a]},calcPosTooltipLeft:function(a,b,c){b=b.outerWidth();var d=c.offset.left||0;return"top"===a||"bottom"===a?(b-c.size.width)/2+d+"px":
"left"===a?-c.size.width+d+"px":"right"===a?b+d+"px":!1},calcPosTooltipTop:function(a,b,c){b=b.innerHeight();var d=c.offset.top||0;return"left"===a||"right"===a?-(c.size.height/2)+b/2+d+"px":"top"===a?-(c.size.height+d)+"px":"bottom"===a?b+d+"px":!1},calcToooltipPosition:function(a,b){"top"===b.paneltype.position?b.position={top:jsPanel.calcPosTooltipTop("top",a,b),left:jsPanel.calcPosTooltipLeft("top",a,b)}:"bottom"===b.paneltype.position?b.position={top:jsPanel.calcPosTooltipTop("bottom",a,b),left:jsPanel.calcPosTooltipLeft("bottom",
a,b)}:"left"===b.paneltype.position?b.position={top:jsPanel.calcPosTooltipTop("left",a,b),left:jsPanel.calcPosTooltipLeft("left",a,b)}:"right"===b.paneltype.position&&(b.position={top:jsPanel.calcPosTooltipTop("right",a,b),left:jsPanel.calcPosTooltipLeft("right",a,b)});return b.position},calcposCenter:function(a){var b=d(a.selector).outerWidth()/2-parseInt(a.size.width,10)/2;return{top:("body"===a.selector?d(window).outerHeight()/2-(parseInt(a.size.height,10)/2-jsPanel.winscrollTop()):d(a.selector).outerHeight()/
2-parseInt(a.size.height,10)/2)+"px",left:b+"px"}},calcverticalOffset:function(a){return a.offset().top-jsPanel.winscrollTop()},close:function(a,b,c){var f=a.parent(),e=a.attr("id");jsPanel.closeChildpanels(a);f.hasClass("jsPanel-tooltip-wrapper")&&a.unwrap();a.remove();d("body").trigger("jspanelclosed",e);"modal"===b&&d(".jsPanel-backdrop").remove();jsPanel.reposMinimized(jsPanel.widthForMinimized);"hint"===b&&(a=jsPanel.hintsTc.indexOf(e),-1!==a&&(jsPanel.hintsTc.splice(a,1),jsPanel.reposHints(jsPanel.hintsTc,
c)),a=jsPanel.hintsTl.indexOf(e),-1!==a&&(jsPanel.hintsTl.splice(a,1),jsPanel.reposHints(jsPanel.hintsTl,c)),a=jsPanel.hintsTr.indexOf(e),-1!==a&&(jsPanel.hintsTr.splice(a,1),jsPanel.reposHints(jsPanel.hintsTr,c)));return f},closeChildpanels:function(a){var b;d(".jsPanel",a).each(function(){b=d(this).attr("id");d("#"+b).remove();d("body").trigger("jspanelclosed",b)});return a},closeallTooltips:function(){var a;d(".jsPanel-tt").each(function(){a=d(this).attr("id");d("#"+a).unwrap().remove();d("body").trigger("jspanelclosed",
a)})},configControls:function(a,b){"closeonly"===a.buttons?(d(".jsPanel-btn-min, .jsPanel-btn-norm, .jsPanel-btn-max, .jsPanel-btn-small, .jsPanel-btn-smallrev",b).remove(),b.header.title.css("width","calc(100% - 30px)")):"none"===a.buttons&&(d("*",b.header.controls).remove(),b.header.title.css("width","100%"));a.close&&b.control("disable","close");a.maximize&&b.control("disable","maximize");a.minimize&&b.control("disable","minimize");a.normalize&&b.control("disable","normalize");a.smallify&&b.control("disable",
"smallify")},configIconfont:function(a,b){d("*",b.header.controls).css("background-image","none");"bootstrap"===a?(d(".jsPanel-btn-close",b.header.controls).empty().append('<span class="glyphicon glyphicon-remove"></span>'),d(".jsPanel-btn-max",b.header.controls).empty().append('<span class="glyphicon glyphicon-fullscreen"></span>'),d(".jsPanel-btn-norm",b.header.controls).empty().append('<span class="glyphicon glyphicon-resize-full"></span>'),d(".jsPanel-btn-min",b.header.controls).empty().append('<span class="glyphicon glyphicon-minus"></span>'),
d(".jsPanel-btn-small",b.header.controls).empty().append('<span class="glyphicon glyphicon-chevron-up"></span>'),d(".jsPanel-btn-smallrev",b.header.controls).empty().append('<span class="glyphicon glyphicon-chevron-down"></span>')):"font-awesome"===a&&(d(".jsPanel-btn-close",b.header.controls).empty().append('<i class="fa fa-times"></i>'),d(".jsPanel-btn-max",b.header.controls).empty().append('<i class="fa fa-arrows-alt"></i>'),d(".jsPanel-btn-norm",b.header.controls).empty().append('<i class="fa fa-expand"></i>'),
d(".jsPanel-btn-min",b.header.controls).empty().append('<i class="fa fa-minus"></i>'),d(".jsPanel-btn-small",b.header.controls).empty().append('<i class="fa fa-chevron-up"></i>'),d(".jsPanel-btn-smallrev",b.header.controls).empty().append('<i class="fa fa-chevron-down"></i>'))},configToolbar:function(a,b,c){var f,e,g,k=a.length;for(f=0;f<k;f+=1)if("object"===typeof a[f]&&(e=d(a[f].item),g=e.prop("tagName").toLowerCase(),"button"===g&&(e.append(a[f].btntext),"string"===typeof a[f].btnclass&&e.addClass(a[f].btnclass)),
b.append(e),d.isFunction(a[f].callback)))e.on(a[f].event,c,a[f].callback)},control:function(a,b,c){if(3===arguments.length)if("disable"===arguments[1])a.fcHeader=d(".jsPanel-hdr",a).css("color"),"close"===c&&(c=d(".jsPanel-btn-close",a.header.controls)),"maximize"===c&&(c=d(".jsPanel-btn-max",a.header.controls)),"minimize"===c&&(c=d(".jsPanel-btn-min",a.header.controls)),"normalize"===c&&(c=d(".jsPanel-btn-norm",a.header.controls)),"smallify"===c&&(c=d(".jsPanel-btn-small",a.header.controls)),c.off().css({color:"rgb(150,150,150)",
cursor:"default"});else if("enable"===arguments[1]){var f;"close"===c&&(f=d(".jsPanel-btn-close",a.header.controls));"maximize"===c&&(f=d(".jsPanel-btn-max",a.header.controls));"minimize"===c&&(f=d(".jsPanel-btn-min",a.header.controls));"normalize"===c&&(f=d(".jsPanel-btn-norm",a.header.controls));"smallify"===c&&(f=d(".jsPanel-btn-small",a.header.controls));f.on("click",function(b){b.preventDefault();a[c]()}).css({color:a.fcHeader,cursor:"pointer"})}return a},dblclickhelper:function(a,b){if("string"===
typeof a)if("maximize"===a||"normalize"===a)"maximized"!==b.status?b.maximize():b.normalize();else if("minimize"===a||"smallify"===a||"close"===a)b[a]()},docouterHeight:function(){return d(document).outerHeight()},fixPosition:function(a){var b=a.offset().top-jsPanel.winscrollTop();a.jsPanelfixPos=function(){a.css("top",jsPanel.winscrollTop()+b+"px")};d(window).on("scroll",a.jsPanelfixPos)},getTitle:function(a){return a.header.title.html()},hideControls:function(a,b){d(".jsPanel-btn-close, .jsPanel-btn-norm, .jsPanel-btn-min, .jsPanel-btn-max, .jsPanel-btn-small, .jsPanel-btn-smallrev",
b).css("display","block");d(a,b).css("display","none")},hintTop:function(a){var b,c=0,f=a.length;for(b=0;b<f;b+=1)c+=d("#"+a[b]).outerHeight(!0);return a===jsPanel.hintsTr?{top:c,right:0}:a===jsPanel.hintsTl?{top:c,left:0}:a===jsPanel.hintsTc?{top:c,left:"center"}:{top:0,left:0}},insertModalBackdrop:function(){var a='<div class="jsPanel-backdrop" style="height:'+jsPanel.docouterHeight()+'px;"></div>';d("body").append(a)},isBootstrapTheme:function(a){return-1<d.inArray(a,"default primary info success warning danger".split(" "))?
a:"default"},isPosInt:function(a){return null!==a.toString().match(/^\+?[1-9]\d*$/)?!0:!1},maxWithinBody:function(a,b,c){"maximized"!==a.status&&"body"===b&&"default"!==c.paneltype.mode&&(d(window).off("scroll",a.jsPanelfixPos),jsPanel.restoreFromMinimized(a,c),a.animate({top:jsPanel.winscrollTop()+5+"px",left:jsPanel.winscrollLeft()+5+"px",width:jsPanel.winouterWidth()-10+"px",height:jsPanel.winouterHeight()-10+"px"},{done:function(){jsPanel.resizeContent(a);a.animate({opacity:1},{duration:150});
jsPanel.hideControls(".jsPanel-btn-max, .jsPanel-btn-smallrev",a);a.status="maximized";d(a).trigger("jspanelmaximized",a.attr("id"));d(a).trigger("jspanelstatechange",a.attr("id"));jsPanel.fixPosition(a);jsPanel.resizeTitle(a)}}))},maxWithinElement:function(a,b,c){"maximized"!==a.status&&"body"!==b&&"default"!==c.paneltype.mode&&(jsPanel.restoreFromMinimized(a,c),b=parseInt(a.parent().outerWidth(),10)-10+"px",c=parseInt(a.parent().outerHeight(),10)-10+"px",a.animate({top:"5px",left:"5px",width:b,
height:c},{done:function(){jsPanel.resizeContent(a);a.animate({opacity:1},{duration:150});jsPanel.hideControls(".jsPanel-btn-max, .jsPanel-btn-smallrev",a);a.status="maximized";d(a).trigger("jspanelmaximized",a.attr("id"));d(a).trigger("jspanelstatechange",a.attr("id"));jsPanel.resizeTitle(a)}}))},maximize:function(a,b,c){"body"===b?jsPanel.maxWithinBody(a,"body",c):jsPanel.maxWithinElement(a,b,c);return a},minimize:function(a,b){"normalized"===a.status&&(b.width=a.outerWidth()+"px",b.height=a.outerHeight()+
...
"right");d(".jsPanel-ftr",a).append('<div style="clear:both;height:0;"></div>');d("button",a.footer).css("float","left")},setTitle:function(a,b){b&&"string"===typeof b&&a.header.title.html(b);return a},setTooltipDefaults:function(a){a.position={};a.resizable=!1;a.draggable=!1;a.show="fadeIn";a.controls.buttons="closeonly"},setZi:function(){var a=0;d(".jsPanel").each(function(){d(this).zIndex()>a&&(a=d(this).zIndex())});return a+1},smallify:function(a){if("smallified"!==a.status&&"smallifiedMax"!==
