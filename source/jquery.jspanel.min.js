...
configToolbar:function(a,b,c){var f,e,g,k=a.length;for(f=0;f<k;f+=1)if("object"===typeof a[f]&&(e=d(a[f].item),g=e.prop("tagName").toLowerCase(),"button"===g&&(e.append(a[f].btntext),"string"===typeof a[f].btnclass&&e.addClass(a[f].btnclass)),b.append(e),d.isFunction(a[f].callback)))e.on(a[f].event,c,a[f].callback)},control:function(a,b,c){if(3===arguments.length)if("disable"===arguments[1])a.fcHeader=d(".jsPanel-hdr",a).css("color"),"close"===c&&(c=d(".jsPanel-btn-close",a.header.controls)),"maximize"===
c&&(c=d(".jsPanel-btn-max",a.header.controls)),"minimize"===c&&(c=d(".jsPanel-btn-min",a.header.controls)),"normalize"===c&&(c=d(".jsPanel-btn-norm",a.header.controls)),"smallify"===c&&(c=d(".jsPanel-btn-small",a.header.controls)),c.off().css({color:"rgb(150,150,150)",cursor:"default"});else if("enable"===arguments[1]){var f;"close"===c&&(f=d(".jsPanel-btn-close",a.header.controls));"maximize"===c&&(f=d(".jsPanel-btn-max",a.header.controls));"minimize"===c&&(f=d(".jsPanel-btn-min",a.header.controls));
"normalize"===c&&(f=d(".jsPanel-btn-norm",a.header.controls));"smallify"===c&&(f=d(".jsPanel-btn-small",a.header.controls));f.on("click",function(b){b.preventDefault();a[c]()}).css({color:a.fcHeader,cursor:"pointer"})}return a},dblclickhelper:function(a,b){if("string"===typeof a)if("maximize"===a||"normalize"===a)"maximized"!==b.status?b.maximize():b.normalize();else if("minimize"===a||"smallify"===a||"close"===a)b[a]()},docOuterHeight:function(){return d(document).outerHeight()},fixPosition:function(a){var b=
a.offset().top-jsPanel.winscrollTop();a.jsPanelfixPos=function(){a.css("top",jsPanel.winscrollTop()+b+"px")};d(window).on("scroll",a.jsPanelfixPos)},getTitle:function(a){return a.header.title.html()},hideControls:function(a,b){d(".jsPanel-btn-close, .jsPanel-btn-norm, .jsPanel-btn-min, .jsPanel-btn-max, .jsPanel-btn-small, .jsPanel-btn-smallrev",b.header.controls).css("display","block");d(a,b.header.controls).css("display","none")},hintTop:function(a){var b,c=0,f=a.length;for(b=0;b<f;b+=1)c+=d("#"+
a[b]).outerHeight(!0);return a===jsPanel.hintsTr?{top:c,right:0}:a===jsPanel.hintsTl?{top:c,left:0}:a===jsPanel.hintsTc?{top:c,left:"center"}:{top:0,left:0}},insertModalBackdrop:function(){var a='<div class="jsPanel-backdrop" style="height:'+jsPanel.docOuterHeight()+'px;"></div>';d("body").append(a)},isBootstrapTheme:function(a){return-1<d.inArray(a,"default primary info success warning danger".split(" "))?a:"default"},isPosInt:function(a){return null!==a.toString().match(/^\+?[1-9]\d*$/)?!0:!1},
maxWithinBody:function(a,b){if("maximized"!==a.status&&"default"!==b.paneltype.mode){var c,f;d(window).off("scroll",a.jsPanelfixPos);jsPanel.restoreFromMinimized(a,b);!0===b.controls.maxtoScreen?(c=jsPanel.calcPosmaxtoScreen(a),f=c.top,c=c.left):(f=jsPanel.winscrollTop()+5+"px",c=jsPanel.winscrollLeft()+5+"px");a.animate({top:f,left:c,width:jsPanel.winouterWidth()-10+"px",height:jsPanel.winouterHeight()-10+"px"},{done:function(){jsPanel.resizeContent(a);a.animate({opacity:1},{duration:150});jsPanel.hideControls(".jsPanel-btn-max, .jsPanel-btn-smallrev",
a);a.status="maximized";d(a).trigger("jspanelmaximized",a.attr("id"));d(a).trigger("jspanelstatechange",a.attr("id"));(!b.controls.maxtoScreen||b.controls.maxtoScreen&&"body"===b.selector)&&jsPanel.fixPosition(a,b);jsPanel.resizeTitle(a)}})}},maxWithinElement:function(a,b){if("maximized"!==a.status&&"default"!==b.paneltype.mode){var c,f;jsPanel.restoreFromMinimized(a,b);c=parseInt(a.parent().outerWidth(),10)-10+"px";f=parseInt(a.parent().outerHeight(),10)-10+"px";a.animate({top:"5px",left:"5px",width:c,
height:f},{done:function(){jsPanel.resizeContent(a);a.animate({opacity:1},{duration:150});jsPanel.hideControls(".jsPanel-btn-max, .jsPanel-btn-smallrev",a);a.status="maximized";d(a).trigger("jspanelmaximized",a.attr("id"));d(a).trigger("jspanelstatechange",a.attr("id"));jsPanel.resizeTitle(a)}})}},maximize:function(a,b,c){"body"===b||!0===c.controls.maxtoScreen?jsPanel.maxWithinBody(a,c):jsPanel.maxWithinElement(a,c);return a},minimize:function(a,b){"normalized"===a.status&&(b.width=a.outerWidth()+
"px",b.height=a.outerHeight()+"px");a.animate({opacity:0},{duration:400,complete:function(){a.animate({width:"150px",height:"28px"},{duration:100,complete:function(){jsPanel.movetoMinified(a);jsPanel.resizeTitle(a);a.css("opacity",1)}})}});return a},movetoMinified:function(a){var b=d("#jsPanel-min-container > .jsPanel").length;0===d("#jsPanel-min-container").length&&d("body").append('<div id="jsPanel-min-container"></div>');"minimized"!==a.status&&(a.css({left:b*jsPanel.widthForMinimized+"px",top:0,
opacity:1}).appendTo("#jsPanel-min-container").resizable({disabled:!0}).draggable({disabled:!0}),jsPanel.hideControls(".jsPanel-btn-min, .jsPanel-btn-small, .jsPanel-btn-smallrev",a),d(a).trigger("jspanelminimized",a.attr("id")),d(a).trigger("jspanelstatechange",a.attr("id")),a.status="minimized",d(window).off("scroll",a.jsPanelfixPos))},normalize:function(a,b,c,f){d(window).off("scroll",a.jsPanelfixPos);jsPanel.restoreFromMinimized(a,b);f="body"===c?jsPanel.winscrollTop()+f+"px":b.position.top;a.animate({width:b.size.width,
height:b.size.height,top:f,left:b.position.left},{done:function(){a.animate({opacity:1},{duration:150});jsPanel.hideControls(".jsPanel-btn-norm, .jsPanel-btn-smallrev",a);jsPanel.resizeTitle(a);"disabled"!==b.resizable&&a.resizable("enable");"disabled"!==b.draggable&&a.draggable("enable");a.status="normalized";d(a).trigger("jspanelnormalized",a.attr("id"));d(a).trigger("jspanelstatechange",a.attr("id"));"body"===c&&jsPanel.fixPosition(a);jsPanel.resizeContent(a)}});return a},replaceCSSBottomRight:function(a,
b){var c=a.position(),d=parseInt(c.top,10),e=parseInt(c.left,10);a.css("bottom")&&(a.css({top:parseInt(c.top,10)+"px",bottom:""}),b.top=d);a.css("right")&&(a.css({left:parseInt(c.left,10)+"px",right:""}),b.left=e)},reposHints:function(a,b){var c,f,e,g=a.length;c="body"===b?jsPanel.winscrollTop():0;for(e=0;e<g;e+=1)f=d("#"+a[e]),f.animate({top:c+"px"}),c+=f.outerHeight(!0)},reposHintsScroll:function(a){var b=a.offset().top-jsPanel.winscrollTop();d(window).scroll(function(){a.css("top",jsPanel.winscrollTop()+
b+"px")})},reposMinimized:function(){var a=d("#jsPanel-min-container > .jsPanel"),b=a.length,c;for(c=0;c<b;c+=1)a.eq(c).animate({left:c*jsPanel.widthForMinimized+"px"})},resizeContent:function(a){var b,c=a.outerHeight();b="none"===a.footer.css("display")?a.header.outerHeight():a.header.outerHeight()+a.footer.outerHeight();a.content.css({height:c-b+"px",width:"100%"});return a},resizeTitle:function(a){var b=d(a.header.controls).outerWidth(),b=d(a).outerWidth()-b-15+"px";a.header.title.css("width",
b)},restoreFromMinimized:function(a,b){"minimized"===a.status&&(a.animate({opacity:0},{duration:50}),a.appendTo(b.selector));"disabled"!==b.resizable&&a.resizable("enable");"disabled"!==b.draggable&&a.draggable("enable");jsPanel.reposMinimized(jsPanel.widthForMinimized)},rewriteOPaneltype:function(a){return"modal"===a?{type:"modal",mode:"default"}:"tooltip"===a?{type:"tooltip"}:"hint"===a?{type:"hint"}:"modal"===a.type?(a.mode=a.mode||"default",{type:"modal",mode:a.mode}):"tooltip"===a.type?(a.mode=
a.mode||!1,a.position=a.position||!1,a.solo=a.solo||!1,a.cornerBG=a.cornerBG||!1,a.cornerOX=a.cornerOX||!1,a.cornerOY=a.cornerOY||!1,{type:"tooltip",mode:a.mode,position:a.position,solo:a.solo,cornerBG:a.cornerBG,cornerOX:a.cornerOX,cornerOY:a.cornerOY}):{paneltype:!1}},rewriteOPosition:function(a){return"center"===a?{top:"center",left:"center"}:"auto"===a?{top:"auto",left:"auto"}:"top left"===a?{top:"0",left:"0"}:"top center"===a?{top:"0",left:"center"}:"top right"===a?{top:"0",right:"0"}:"center right"===
a?{top:"center",right:"0"}:"bottom right"===a?{bottom:"0",right:"0"}:"bottom center"===a?{bottom:"0",left:"center"}:"bottom left"===a?{bottom:"0",left:"0"}:"center left"===a?{top:"center",left:"0"}:a},setHintDefaults:function(a,b){a.resizable=!1;a.draggable=!1;a.removeHeader=!0;a.toolbarFooter=!1;a.show="fadeIn";b.addClass("jsPanel-hint");b.content.addClass("jsPanel-hint-content");a.autoclose?0>a.autoclose&&(a.autoclose=!1):a.autoclose=8E3;b.content.addClass("jsPanel-hint-"+a.theme);"default"===a.theme||
"light"===a.theme?b.content.append('<div class="jsPanel-hint-close-dark"></div>'):b.content.append('<div class="jsPanel-hint-close-white"></div>')},setModalDefaults:function(a,b){a.selector="body";a.show="fadeIn";"default"===a.paneltype.mode&&(a.resizable=!1,a.draggable=!1,a.removeHeader=!1,a.position={top:"center",left:"center"},a.offset={top:0,left:0},a.controls.buttons="closeonly",d(".jsPanel-btn-min, .jsPanel-btn-norm, .jsPanel-btn-max, .jsPanel-btn-small, .jsPanel-btn-smallrev",b).remove(),d(b.header,
b.header.title,b.footer).css("cursor","default"),d(".jsPanel-title",b).css("cursor","inherit"))},setPanelId:function(a,b){"string"===typeof b?1>d("#"+b).length?a.attr("id",b):(jsPanel.ID+=1,a.attr("id","jsPanel-"+jsPanel.ID),d(".jsPanel-title",a).html(d(".jsPanel-title",a).text()+" AUTO-ID: "+a.attr("id"))):d.isFunction(b)&&a.attr("id",b)},setRTL:function(a,b){var c=[a.header.title,a.content,a.header.toolbar,a.footer],f,e=c.length;for(f=0;f<e;f+=1)c[f].prop("dir","rtl"),b&&c[f].prop("lang",b);a.header.title.css("text-align",
"right");d(".jsPanel-btn-close",a.header.controls).insertAfter(d(".jsPanel-btn-min",a.header.controls));d(".jsPanel-btn-max",a.header.controls).insertAfter(d(".jsPanel-btn-min",a.header.controls));d(".jsPanel-btn-small",a.header.controls).insertBefore(d(".jsPanel-btn-min",a.header.controls));d(".jsPanel-btn-smallrev",a.header.controls).insertBefore(d(".jsPanel-btn-min",a.header.controls));d(".jsPanel-hdr-r",a).css({left:"0px",right:"",position:"relative","float":"left"});d(".jsPanel-hint-close-dark, .jsPanel-hint-close-white",
a).css("float","left");d(".jsPanel-title",a).css("float","right");d(".jsPanel-ftr",a).append('<div style="clear:both;height:0;"></div>');d("button",a.footer).css("float","left")},setTitle:function(a,b){b&&"string"===typeof b&&a.header.title.html(b);return a},setTooltipDefaults:function(a){a.position={};a.resizable=!1;a.draggable=!1;a.show="fadeIn";a.controls.buttons="closeonly"},setZi:function(){var a=0;d(".jsPanel").each(function(){d(this).zIndex()>a&&(a=d(this).zIndex())});return a+1},smallify:function(a){if("smallified"!==
a.status&&"smallifiedMax"!==a.status){var b;b="maximized"===a.status?"smallifiedMax":"smallified";a.smallify.height=a.outerHeight()+"px";a.panelheaderheight=a.header.outerHeight()-2;a.panelfooterheight=a.footer.outerHeight();a.panelcontentheight=a.content.outerHeight();a.animate({height:a.panelheaderheight+"px"},{done:function(){"maximized"===a.status?jsPanel.hideControls(".jsPanel-btn-max, .jsPanel-btn-small",a):jsPanel.hideControls(".jsPanel-btn-norm, .jsPanel-btn-small",a);a.status=b;d(a).trigger("jspanelsmallified",
a.attr("id"));d(a).trigger("jspanelstatechange",a.attr("id"))}})}else a.animate({height:a.smallify.height},{done:function(){"smallified"===a.status?(jsPanel.hideControls(".jsPanel-btn-norm, .jsPanel-btn-smallrev",a),a.status="normalized",d(a).trigger("jspanelnormalized",a.attr("id"))):(jsPanel.hideControls(".jsPanel-btn-max, .jsPanel-btn-smallrev",a),a.status="maximized",d(a).trigger("jspanelmaximized",a.attr("id")));d(a).trigger("jspanelstatechange",a.attr("id"))}});return a},updateOptionPosition:function(a,
b){b.top=a.css("top");b.left=a.css("left")},updateOptionSize:function(a,b){b.width=a.css("width");b.height=a.css("height")},winouterHeight:function(){return d(window).outerHeight()},winouterWidth:function(){return d(window).outerWidth()},winscrollLeft:function(){return d(window).scrollLeft()},winscrollTop:function(){return d(window).scrollTop()}}})(jQuery);
