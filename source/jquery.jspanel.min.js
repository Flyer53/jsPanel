/* jsPanel version 2.5.0 2015-05-02 16:08 (c)2014-15 Stefan Straesser http://jspanel.de */
...
a["default"]||{};b.forEach(function(b){d="string"===typeof b.custom.config?c.extend(!0,{},e,a[b.custom.config],b):c.extend(!0,{},e,b);c.jsPanel(d)})},fixPosition:function(a){var b=a.offset().top-window.scrollY;a.jsPanelfixPos=function(){a.css("top",window.scrollY+b+"px")};c(window).on("scroll",a.jsPanelfixPos)},getMargins:function(a){var b,d,e,f,g=a.option.paneltype.shiftwithin;f=c(window).outerWidth();d=c(window).outerHeight();var l=a.outerWidth(),m=a.outerHeight();g&&"body"!==g?(d=c(g).offset(),
b=a.offset(),e=c(g).outerWidth()-parseInt(a.css("width"))-(b.left-d.left),f=b.left-d.left,a=c(g).outerHeight()-(b.top-d.top)-parseInt(a.css("height")),b=b.top-d.top):(b=a.offset(),e=f-b.left-l+window.scrollX,f=f-l-e,a=d-b.top-m+window.scrollY,b=d-m-a);return{marginTop:parseInt(b),marginRight:parseInt(e),marginBottom:parseInt(a),marginLeft:parseInt(f)}},getMaxOfArray:function(a){return Math.max.apply(null,a)},getMaxpanelshift:function(a){var b=a.outerWidth(),c=a.outerHeight(),e=parseInt(b/2)+parseInt(a.parent().outerWidth()/
2)-20;a=parseInt(c/2)+parseInt(a.parent().outerHeight()/2)-20;b=parseInt(b/2)-16;c=parseInt(c/2)-16;return{maxshiftH:e,maxshiftV:a,maxCornerH:b,maxCornerV:c}},hideControls:function(a,b){c(".jsPanel-btn-close, .jsPanel-btn-norm, .jsPanel-btn-min, .jsPanel-btn-max, .jsPanel-btn-small, .jsPanel-btn-smallrev, .jsPanel-btn-hide",b.header.controls).css("display","block");c(a,b.header.controls).css("display","none")},hintTop:function(a){var b=0;c("."+a).each(function(){b+=c(this).outerHeight(!0)});return"jsPanel-hint-tr"===
a?{top:b,right:0}:"jsPanel-hint-tl"===a?{top:b,left:0}:"jsPanel-hint-tc"===a?{top:b,left:"center"}:{top:0,left:0}},iframe:function(a){var b=c("<iframe></iframe>");a.option.iframe.srcdoc&&(b.prop("srcdoc",a.option.iframe.srcdoc),a.data("iframeDOC",a.option.iframe.srcdoc));a.option.iframe.src&&(b.prop("src",a.option.iframe.src),a.data("iframeSRC",a.option.iframe.src));"auto"===a.option.size.width||a.option.iframe.width?"string"===typeof a.option.iframe.width&&"%"===a.option.iframe.width.slice(-1)?b.prop("width",
a.option.iframe.width):b.prop("width",parseInt(a.option.iframe.width)+"px"):b.prop("width","100%");"auto"===a.option.size.height||a.option.iframe.height?"string"===typeof a.option.iframe.height&&"%"===a.option.iframe.height.slice(-1)?b.prop("height",a.option.iframe.height):b.prop("height",parseInt(a.option.iframe.height)+"px"):b.prop("height","100%");"string"===typeof a.option.iframe.name&&b.prop("name",a.option.iframe.name);"string"===typeof a.option.iframe.id&&b.prop("id",a.option.iframe.id);a.option.iframe.seamless&&
b.prop("seamless","seamless");"string"===typeof a.option.iframe.sandbox&&b.prop("sandox",a.option.iframe.sandbox);c.isPlainObject(a.option.iframe.style)&&b.css(a.option.iframe.style);"string"===typeof a.option.iframe.classname?b.addClass(a.option.iframe.classname):c.isFunction(a.option.iframe.classname)&&b.addClass(a.option.iframe.classname());a.content.empty().append(b)},insertModalBackdrop:function(){var a='<div class="jsPanel-backdrop" style="height:'+c(document).outerHeight()+'px;"></div>';c("body").append(a)},
