/* jquery.jspanel.js version 2.5.1 released under MIT (c)2014-15 Stefan Straesser <http://jspanel.de/> */
...
parseInt(d.top,10)+window.scrollY+"px":"bottom"===a?b.option.position.bottom=parseInt(d.bottom,10)-window.scrollY+"px":"left"===a?b.option.position.left=parseInt(d.left,10)+window.scrollX+"px":"right"===a&&(b.option.position.right=parseInt(d.right,10)-window.scrollX+"px"));return b.option.position[a]},calcPosCenter:function(a){var b=a.selector;a=a.size;var d=c(b).outerWidth()/2-parseInt(a.width,10)/2;return{top:("body"===b?c(window).outerHeight()/2-(parseInt(a.height,10)/2-window.scrollY):c(b).outerHeight()/
2-parseInt(a.height,10)/2)+"px",left:d+"px"}},calcPosmaxtoScreen:function(a){var b=a.offset();return{top:parseInt(a.css("top"))-(b.top-c(document).scrollTop())+5+"px",left:parseInt(a.css("left"))-(b.left-c(document).scrollLeft())+5+"px"}},calcPosTooltipLeft:function(a,b){var c=a.outerWidth(),e=parseInt(a.css("margin-left")),f=b.offset.left||0,g=b.paneltype.position;return"top"===g||"bottom"===g?(c-b.size.width)/2+e+f+"px":"left"===g?-b.size.width+e+f+"px":"right"===g?c+e+f+"px":!1},calcPosTooltipTop:function(a,
b){var c=a.innerHeight(),e=parseInt(a.css("margin-top")),f=b.offset.top||0,g=b.paneltype.position;return"left"===g||"right"===g?-(b.size.height/2)+c/2+e+f+"px":"top"===g?-(b.size.height+f)+e+"px":"bottom"===g?c+e+f+"px":!1},calcToooltipPosition:function(a,b){return{top:this.calcPosTooltipTop(a,b),left:this.calcPosTooltipLeft(a,b)}},calcVerticalOffset:function(a){return Math.floor(a.offset().top-window.scrollY)},close:function(a){var b=a.parent(),d=a.attr("id");a.trigger("jspanelbeforeclose",d);this.closeChildpanels(a);
b.hasClass("jsPanel-tooltip-wrapper")&&a.unwrap();a.remove();c("body").trigger("jspanelclosed",d);"modal"===a.option.paneltype.type&&c(".jsPanel-backdrop").remove();this.reposMinimized(this.widthForMinimized);"hint"===a.option.paneltype.type&&(a.hasClass("jsPanel-hint-tl")?jsPanel.reposHints("jsPanel-hint-tl",a.parentElmtTagname):a.hasClass("jsPanel-hint-tc")?jsPanel.reposHints("jsPanel-hint-tc",a.parentElmtTagname):a.hasClass("jsPanel-hint-tr")&&jsPanel.reposHints("jsPanel-hint-tr",a.parentElmtTagname));
return b},closeallTooltips:function(){c(".jsPanel-tt").each(function(){c(this).unwrap().remove();c("body").trigger("jspanelclosed",c(this).attr("id"))})},closeChildpanels:function(a){c(".jsPanel",a).each(function(){a.trigger("jspanelbeforeclose",c(this).attr("id"));c(this).remove();c("body").trigger("jspanelclosed",c(this).attr("id"))});return a},configControls:function(a){"closeonly"===a.option.controls.buttons?(c(".jsPanel-btn-min, .jsPanel-btn-norm, .jsPanel-btn-max, .jsPanel-btn-small, .jsPanel-btn-smallrev, .jsPanel-btn-hide",
...
f=c(".jsPanel-btn-close",e):"maximize"===d?f=c(".jsPanel-btn-max",e):"minimize"===d?f=c(".jsPanel-btn-min",e):"normalize"===d?f=c(".jsPanel-btn-norm",e):"smallify"===d&&(f=c(".jsPanel-btn-small",e)),f.on("click",function(b){b.preventDefault();a[d]()}).css({opacity:1,cursor:"pointer"})));return a},dblclickhelper:function(a,b){if("string"===typeof a)if("maximize"===a||"normalize"===a)"normalized"===b.status||"normalized"===b.option.panelstatus?b.maximize():b.normalize();else if("minimize"===a||"smallify"===
a||"close"===a)b[a]()},exportPanels:function(){var a,b,d,e,f,g,l,m=[],k;c(".jsPanel").not(".jsPanel-tt, .jsPanel-hint, .jsPanel-modal").each(function(n,h){k={panelstatus:c(h).data("panelstatus"),id:c(h).prop("id"),title:c(".jsPanel-title",h).html(),custom:c(h).data("custom"),offset:{top:0,left:0},content:c(h).data("content")};"normalized"!==c(h).data("panelstatus")&&c(".jsPanel-btn-norm",h).trigger("click");l=c(h).data("selector");a=c(h).offset();b=c(h).position();"body"===l.toLowerCase()?(d=Math.floor(a.top-
window.scrollY)+"px",e=Math.floor(a.left-window.scrollX)+"px"):(d=Math.floor(b.top)+"px",e=Math.floor(b.left)+"px");f=c(h).css("width");g=c(".jsPanel-content",h).css("height");k.size={width:f,height:g};k.position={top:d,left:e};c(h).data("loadURL")&&(k.load={},k.load.url=c(h).data("loadURL"));c(h).data("ajaxURL")&&(k.ajax={},k.ajax.url=c(h).data("ajaxURL"));if(c(h).data("iframeDOC")||c(h).data("iframeSRC"))k.iframe={},c(h).data("iframeDOC")&&(k.iframe.srcdoc=c(h).data("iframeDOC")),c(h).data("iframeSRC")&&
(k.iframe.src=c(h).data("iframeSRC"));m.push(k);switch(k.panelstatus){case "minimized":c(".jsPanel-btn-min",h).trigger("click");break;case "maximized":c(".jsPanel-btn-max",h).trigger("click");break;case "smallified":c(".jsPanel-btn-small",h).trigger("click");break;case "smallifiedMax":c(".jsPanel-btn-small",h).trigger("click")}});window.localStorage.setItem("jspanels",JSON.stringify(m));return m},importPanels:function(a){var b,d,e;b=JSON.parse(localStorage.jspanels)||{};e=a["default"]||{};b.forEach(function(b){d=
"string"===typeof b.custom.config?c.extend(!0,{},e,a[b.custom.config],b):c.extend(!0,{},e,b);c.jsPanel(d)})},fixPosition:function(a){var b=a.offset().top-window.scrollY;a.jsPanelfixPos=function(){a.css("top",window.scrollY+b+"px")};c(window).on("scroll",a.jsPanelfixPos)},getMargins:function(a){var b,d,e,f,g=a.option.paneltype.shiftwithin;f=c(window).outerWidth();d=c(window).outerHeight();var l=a.outerWidth(),m=a.outerHeight();g&&"body"!==g?(d=c(g).offset(),b=a.offset(),e=c(g).outerWidth()-parseInt(a.css("width"))-
(b.left-d.left),f=b.left-d.left,a=c(g).outerHeight()-(b.top-d.top)-parseInt(a.css("height")),b=b.top-d.top):(b=a.offset(),e=f-b.left-l+window.scrollX,f=f-l-e,a=d-b.top-m+window.scrollY,b=d-m-a);return{marginTop:parseInt(b),marginRight:parseInt(e),marginBottom:parseInt(a),marginLeft:parseInt(f)}},getMaxOfArray:function(a){return Math.max.apply(null,a)},getMaxpanelshift:function(a){var b=a.outerWidth(),c=a.outerHeight(),e=parseInt(b/2)+parseInt(a.parent().outerWidth()/2)-20;a=parseInt(c/2)+parseInt(a.parent().outerHeight()/
2)-20;b=parseInt(b/2)-16;c=parseInt(c/2)-16;return{maxshiftH:e,maxshiftV:a,maxCornerH:b,maxCornerV:c}},hideControls:function(a,b){c(".jsPanel-btn-close, .jsPanel-btn-norm, .jsPanel-btn-min, .jsPanel-btn-max, .jsPanel-btn-small, .jsPanel-btn-smallrev, .jsPanel-btn-hide",b.header.controls).css("display","block");c(a,b.header.controls).css("display","none")},hintTop:function(a){var b=0;c("."+a).each(function(){b+=c(this).outerHeight(!0)});return"jsPanel-hint-tr"===a?{top:b,right:0}:"jsPanel-hint-tl"===
a?{top:b,left:0}:"jsPanel-hint-tc"===a?{top:b,left:"center"}:{top:0,left:0}},iframe:function(a){var b=c("<iframe></iframe>");a.option.iframe.srcdoc&&(b.prop("srcdoc",a.option.iframe.srcdoc),a.data("iframeDOC",a.option.iframe.srcdoc));a.option.iframe.src&&(b.prop("src",a.option.iframe.src),a.data("iframeSRC",a.option.iframe.src));"auto"===a.option.size.width||a.option.iframe.width?"string"===typeof a.option.iframe.width&&"%"===a.option.iframe.width.slice(-1)?b.prop("width",a.option.iframe.width):b.prop("width",
parseInt(a.option.iframe.width)+"px"):b.prop("width","100%");"auto"===a.option.size.height||a.option.iframe.height?"string"===typeof a.option.iframe.height&&"%"===a.option.iframe.height.slice(-1)?b.prop("height",a.option.iframe.height):b.prop("height",parseInt(a.option.iframe.height)+"px"):b.prop("height","100%");"string"===typeof a.option.iframe.name&&b.prop("name",a.option.iframe.name);"string"===typeof a.option.iframe.id&&b.prop("id",a.option.iframe.id);a.option.iframe.seamless&&b.prop("seamless",
"seamless");"string"===typeof a.option.iframe.sandbox&&b.prop("sandox",a.option.iframe.sandbox);c.isPlainObject(a.option.iframe.style)&&b.css(a.option.iframe.style);"string"===typeof a.option.iframe.classname?b.addClass(a.option.iframe.classname):c.isFunction(a.option.iframe.classname)&&b.addClass(a.option.iframe.classname());a.content.empty().append(b)},insertModalBackdrop:function(){var a='<div class="jsPanel-backdrop" style="height:'+c(document).outerHeight()+'px;"></div>';c("body").append(a)},
isBootstrapTheme:function(a){return-1<c.inArray(a,"default primary info success warning danger".split(" "))?a:"default"},load:function(a){a.content.load(a.option.load.url,a.option.load.data||void 0,function(b,c,e){a.option.load.complete&&a.option.load.complete(b,c,e,a);jsPanel.resizeTitle(a);jsPanel.updateOptionSize(a,a.option.size);a.content.css("width",function(){return a.content.outerWidth()+"px"})});a.data("loadURL",a.option.load.url)},maxWithinBody:function(a){var b,d;"maximized"===a.status&&
"maximized"===a.option.panelstatus||"default"===a.option.paneltype.mode||(c(window).off("scroll",a.jsPanelfixPos),"minimized"!==a.status&&"minimized"!==a.option.panelstatus||this.restoreFromMinimized(a),!0===a.option.controls.maxtoScreen?(b=this.calcPosmaxtoScreen(a),d=b.top+parseInt(a.option.maximizedMargin.top)+"px",b=b.left+parseInt(a.option.maximizedMargin.left)+"px"):(d=c(window).scrollTop()+parseInt(a.option.maximizedMargin.top)+"px",b=c(window).scrollLeft()+parseInt(a.option.maximizedMargin.left)+
"px"),a.css({top:d,left:b,width:c(window).outerWidth()-parseInt(a.option.maximizedMargin.left)-parseInt(a.option.maximizedMargin.right)+"px",height:c(window).outerHeight()-parseInt(a.option.maximizedMargin.top)-parseInt(a.option.maximizedMargin.bottom)+"px"}),(!a.option.controls.maxtoScreen||a.option.controls.maxtoScreen&&"body"===a.option.selector)&&this.fixPosition(a))},maxWithinElement:function(a){"maximized"===a.status&&"maximized"===a.option.panelstatus||"default"===a.option.paneltype.mode||
("minimized"!==a.status&&"minimized"!==a.option.panelstatus||this.restoreFromMinimized(a),a.css({top:parseInt(a.option.maximizedMargin.top)+"px",left:parseInt(a.option.maximizedMargin.left)+"px",width:parseInt(a.parent().outerWidth(),10)-parseInt(a.option.maximizedMargin.left)-parseInt(a.option.maximizedMargin.right)+"px",height:parseInt(a.parent().outerHeight(),10)-parseInt(a.option.maximizedMargin.top)-parseInt(a.option.maximizedMargin.bottom)+"px"}))},maximize:function(a){a.trigger("jspanelbeforemaximize",
a.attr("id"));"body"===a.parentElmtTagname||!0===a.option.controls.maxtoScreen?this.maxWithinBody(a):this.maxWithinElement(a);a.trigger("jspanelmaximized",a.attr("id"));a.trigger("jspanelstatechange",a.attr("id"));return a},minimize:function(a){a.trigger("jspanelbeforeminimize",a.attr("id"));a.data({paneltop:parseInt(a.option.position.top),panelleft:parseInt(a.option.position.left),panelwidth:parseInt(a.option.size.width),panelheight:parseInt(c(".jsPanel-content",a).css("height"))});if("normalized"===
a.status||"normalized"===a.option.panelstatus)a.option.size.width=a.outerWidth()+"px",a.option.size.height=a.outerHeight()+"px";a.animate({opacity:0},{duration:400,complete:function(){a.animate({width:jsPanel.widthForMinimized+"px",height:"28px"},{duration:100,complete:function(){jsPanel.movetoMinified(a);jsPanel.resizeTitle(a);a.css("opacity",1)}})}});return a},movetoMinified:function(a){0===c("#jsPanel-min-container").length&&c("body").append('<div id="jsPanel-min-container"></div>');if("minimized"!==
a.status||"minimized"!==a.option.panelstatus)a.css({left:c(".jsPanel","#jsPanel-min-container").length*jsPanel.widthForMinimized+"px",top:0,opacity:1}).appendTo("#jsPanel-min-container").resizable({disabled:!0}).draggable({disabled:!0}),a.trigger("jspanelminimized",a.attr("id")),a.trigger("jspanelstatechange",a.attr("id"))},normalize:function(a){a.trigger("jspanelbeforenormalize",a.attr("id"));c(window).off("scroll",a.jsPanelfixPos);"minimized"!==a.status&&"minimized"!==a.option.panelstatus||this.restoreFromMinimized(a);
a.css({width:a.option.size.width,height:a.option.size.height,top:"body"===a.parentElmtTagname?window.scrollY+a.verticalOffset+"px":a.option.position.top,left:a.option.position.left});["resizable","draggable"].forEach(function(b){"disabled"!==a.option[b]&&(a[b]("enable"),c(".ui-icon-gripsmall-diagonal-se",a).css({"background-image":"none","text-indent":0}),c(".ui-resizable-handle",a).css({cursor:""}))});a.trigger("jspanelnormalized",a.attr("id"));a.trigger("jspanelstatechange",a.attr("id"));"body"===
a.parentElmtTagname&&this.fixPosition(a);return a},replaceCSSBottomRight:function(a){var b=a.position();a.css("bottom")&&(a.css({top:parseInt(b.top,10)+"px",bottom:""}),a.option.position.top=parseInt(b.top,10));a.css("right")&&(a.css({left:parseInt(b.left,10)+"px",right:""}),a.option.position.left=parseInt(b.left,10))},reposHints:function(a,b){var d;d="body"===b?window.scrollY:0;c("."+a).each(function(){c(this).animate({top:d+"px"});d+=c(this).outerHeight(!0)})},reposHintsScroll:function(a){var b=
a.offset().top-window.scrollY;c(window).scroll(function(){a.css("top",window.scrollY+b+"px")})},reposition:function(a,b,d){d&&"string"===typeof d&&(a.option.selector=d,a.appendTo(d),a.parentElmt=c(d).first(),a.parentElmtTagname=a.parentElmt[0].tagName.toLowerCase());"tooltip"!==a.option.paneltype.type&&"hint"!==a.option.paneltype.type&&(a.option.position=jsPanel.rewriteOPosition(b),a.css({top:"",right:"",bottom:"",left:""}),this.calcPanelposition(a),a.verticalOffset=jsPanel.calcVerticalOffset(a)||
...
jsPanel.dblclickhelper(b.option.dblclicks.content,b)});if(b.option.dblclicks.footer)b.footer.on("dblclick",function(a){a.preventDefault();jsPanel.dblclickhelper(b.option.dblclicks.footer,b)})}if(b.option.show)if(-1===b.option.show.indexOf(" "))b[b.option.show]({done:function(){c(b).trigger("jspanelloaded",b.attr("id"));c(b).trigger("jspanelstatechange",b.attr("id"));b.option.size={width:b.outerWidth()+"px",height:b.outerHeight()+"px"}}});else b.css({display:"block",opacity:1}).addClass(b.option.show).trigger("jspanelloaded",
b.attr("id")).trigger("jspanelstatechange",b.attr("id")),b.option.size={width:b.outerWidth()+"px",height:b.outerHeight()+"px"};else b.css({display:"block",opacity:1}).trigger("jspanelloaded",b.attr("id")).trigger("jspanelstatechange",b.attr("id")),b.option.size={width:b.outerWidth()+"px",height:b.outerHeight()+"px"};b.verticalOffset=jsPanel.calcVerticalOffset(b)||0;jsPanel.replaceCSSBottomRight(b);b.header.title.empty().prepend(b.option.title);jsPanel.resizeTitle(b);"hint"===b.option.paneltype.type&&
jsPanel.reposHintsScroll(b);"body"!==b.parentElmtTagname||"tooltip"===b.option.paneltype.type&&"hint"===b.option.paneltype.type||jsPanel.fixPosition(b);b.option.paneltype&&"default"===b.option.paneltype.mode||(c(b).on("resizestart",function(){c("iframe",b.content).css("display","none")}),c(b).on("resize",function(){jsPanel.resizeContent(b);jsPanel.resizeTitle(b)}),c(b).on("resizestop",function(){b.option.size={width:b.outerWidth()+"px",height:b.outerHeight()+"px"};jsPanel.updateStateProps(b,"normalized");
c(b).trigger("jspanelnormalized",b.attr("id"));c(b).trigger("jspanelstatechange",b.attr("id"));jsPanel.hideControls(".jsPanel-btn-norm, .jsPanel-btn-smallrev",b);c("iframe",b.content).css("display","block")}),c(b).on("dragstart",function(){c(window).off("scroll",b.jsPanelfixPos);"extended"===b.option.paneltype.mode&&b.css("z-index","10000")}),c(b).on("dragstop",function(){b.option.position={top:b.css("top"),left:b.css("left")};b.verticalOffset=jsPanel.calcVerticalOffset(b)||0;"body"===b.parentElmtTagname&&
jsPanel.fixPosition(b)}),c(b).on("jspanelminimized",function(){jsPanel.hideControls(".jsPanel-btn-min, .jsPanel-btn-small, .jsPanel-btn-smallrev, .jsPanel-btn-hide",b);jsPanel.updateStateProps(b,"minimized");c(window).off("scroll",b.jsPanelfixPos)}),c(b).on("jspanelmaximized",function(){jsPanel.resizeContent(b);jsPanel.resizeTitle(b);jsPanel.hideControls(".jsPanel-btn-max, .jsPanel-btn-smallrev",b);jsPanel.updateStateProps(b,"maximized");b.trigger("resize")}),c(b).on("jspanelnormalized",function(){jsPanel.hideControls(".jsPanel-btn-norm, .jsPanel-btn-smallrev",
b);jsPanel.resizeTitle(b);jsPanel.resizeContent(b);jsPanel.updateStateProps(b,"normalized");b.trigger("resize")}));"number"===typeof b.option.autoclose&&0<b.option.autoclose&&jsPanel.autoclose(b);"tooltip"!==b.option.paneltype.type||"top"!==b.option.paneltype.position&&"bottom"!==b.option.paneltype.position?"left"!==b.option.paneltype.position&&"right"!==b.option.paneltype.position||jsPanel.shiftTooltipVertical(b,b.option.paneltype.shiftwithin):jsPanel.shiftTooltipHorizontal(b,b.option.paneltype.shiftwithin);
if(b.option.panelstatus)switch(b.option.panelstatus){case "minimized":jsPanel.minimize(b);break;case "maximized":jsPanel.maximize(b);break;case "smallified":jsPanel.smallify(b);break;case "smallifiedMax":jsPanel.maximize(b),jsPanel.smallify(b)}else jsPanel.updateStateProps(b,"normalized");b.option.callback&&c.isFunction(b.option.callback)?b.option.callback(b):c.isArray(b.option.callback)&&b.option.callback.forEach(function(a){c.isFunction(a)&&a(b)});return b};c.jsPanel.defaults={addClass:{header:!1,
content:!1,footer:!1},ajax:!1,autoclose:!1,bootstrap:!1,callback:void 0,content:!1,controls:{buttons:!0,iconfont:"jsglyph",close:!1,confirmClose:!1,maximize:!1,minimize:!1,normalize:!1,smallify:!1,maxtoScreen:!1},custom:!1,dblclicks:!1,draggable:{handle:"div.jsPanel-hdr, div.jsPanel-ftr",stack:".jsPanel",opacity:.7},id:function(){jsPanel.ID+=1;return"jsPanel-"+jsPanel.ID},iframe:!1,load:!1,maximizedMargin:{top:5,right:5,bottom:5,left:5},offset:{top:0,left:0},panelstatus:!1,paneltype:!1,overflow:"hidden",
position:"auto",removeHeader:!1,resizable:{handles:"n, e, s, w, ne, se, sw, nw",autoHide:!1,minWidth:150,minHeight:93},rtl:!1,selector:"body",show:"fadeIn",size:{width:"400px",height:"222px"},template:!1,theme:"default",title:"jsPanel",toolbarFooter:!1,toolbarHeader:!1};c.fn.alterClass=function(a,b){var d;if(-1===a.indexOf("*"))return this.removeClass(a),b?this.addClass(b):this;d=new RegExp("\\s"+a.replace(/\*/g,"[A-Za-z0-9-_]+").split(" ").join("\\s|\\s")+"\\s","g");this.each(function(a,b){for(var g=
" "+b.className+" ";d.test(g);)g=g.replace(d," ");b.className=c.trim(g)});return b?this.addClass(b):this};c("body").click(function(a){var b;1>c(a.target).closest(".jsPanel-tt").length&&c(".jsPanel-tt").each(function(){b=c(this).attr("id");c("#"+b).unwrap().remove();c("body").trigger("jspanelclosed",b)})})})(jQuery);Number.isInteger||(Number.isInteger=function(c){return"number"===typeof c&&isFinite(c)&&-9007199254740992<c&&9007199254740992>c&&Math.floor(c)===c});