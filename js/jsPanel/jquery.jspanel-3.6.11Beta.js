/* jQuery Plugin jsPanel
   Version: 3.6.11Beta 2014-03-07 10:45
   Dependencies:
...
var jsPanelversion = 'jsPanel Version: 3.6.11Beta 2014-03-07 10:45';
...
(function ( $ ) {
    ...
    $.fn.jsPanel = function( config , callback ) {
        ...
        // wenn die id nicht über das Konfig-Objekt gesetzt wird, wird mit der jQuery-UI Methode .uniqueId() eine erzeugt und gesetzt
        if( option.id )
        {
