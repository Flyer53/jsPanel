/* jQuery Plugin jsPanel
   Version: 3.6.13Beta 2014-03-12 09:37
   Dependencies:
...
var jsPanelversion = 'jsPanel Version: 3.6.13Beta 2014-03-12 09:37';
...
(function ( $ ) {
    ...
    $.fn.jsPanel = function( config , callback ) {
        ...
        if( option.load && $.isPlainObject( option.load ) )
        {
            ...
            $( '.jsPanel-content' , jsPanel ).load( url, data, complete );
        }
        ...
        if( option.ajax && $.isPlainObject( option.ajax ) )
        {
            $.ajax( option.ajax )
            .done( function( data ){
                $( '.jsPanel-content' , jsPanel ).append( data );
            });
        }
